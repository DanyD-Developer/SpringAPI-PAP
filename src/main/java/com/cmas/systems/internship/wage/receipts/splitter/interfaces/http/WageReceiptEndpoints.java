...
public class WageReceiptEndpoints {
	...
	@PostMapping( "/upload" )
	public ResponseEntity<List<WageReceiptOwnerResult>> getRequest( @RequestParam( "wageReceiptPdf" ) MultipartFile wageReceiptPdf, @RequestParam( "pwdFile" ) MultipartFile pwdFile ) {
