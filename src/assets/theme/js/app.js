...
(function ($) {
  ...
  // scroll content
  // can be replaced by angular library https://www.npmjs.com/package/ngx-slimscroll
  ...
  // left secondary sidebar - used on some nested menus
  ...
  // Didn't find where this is applied
 ...
 //  }
  ...
  // can be replaced by angular library https://www.npmjs.com/package/angular-feather
 ...
 //  }
  ...
  function init() {
    ...
    Waves.init();
    // initnavbarMenu();
    // initRightbarChart(); FIXME changed to work
    // initstickyTabText();
  }
